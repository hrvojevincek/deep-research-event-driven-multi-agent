...
**Strategy:** Phases 0–4 complete. **Phase 5 in progress** — Terraform networking, RDS, ECS modules + ADR-012 ✅. **Next:** SQS, EventBridge, Cognito modules.
...
| **5** | AWS deploy (Terraform, ECS, Step Functions fan-out)                           | **In progress** — networking + RDS + ECS modules; SQS/Cognito next                                                                                                                                                                                                                                                        |
...
| **IaC** _(Phase 5)_      | Terraform — `modules/networking`, `modules/rds`, `modules/ecs`, `environments/dev` |
